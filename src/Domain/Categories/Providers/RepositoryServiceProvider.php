...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \Src\Domain\Categories\Repositories\Contracts\CategoriesRepository::class => \Src\Domain\Categories\Repositories\Eloquent\CategoriesRepositoryEloquent::class,
