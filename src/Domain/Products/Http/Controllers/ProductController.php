...
namespace Src\Domain\Products\Http\Controllers;

use Src\Infrastructure\Http\AbstractControllers\BaseController as Controller;
use Src\Domain\Products\Http\Requests\Product\ProductStoreFormRequest;
use Src\Domain\Products\Http\Requests\Product\ProductUpdateFormRequest;
...
use Src\Domain\Products\Http\Resources\Product\ProductResourceCollection;
use Src\Domain\Products\Http\Resources\Product\ProductResource;
...
class ProductController extends Controller
{
    ...
    {
        $index = $this->productRepository->spatie()->paginate();
    ...
    {
        $product=$this->productRepository->spatie()->find($product);
