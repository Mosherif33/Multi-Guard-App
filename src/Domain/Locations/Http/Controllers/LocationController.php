...
namespace Src\Domain\Locations\Http\Controllers;

use Src\Infrastructure\Http\AbstractControllers\BaseController as Controller;
use Src\Domain\Locations\Http\Requests\Location\LocationStoreFormRequest;
use Src\Domain\Locations\Http\Requests\Location\LocationUpdateFormRequest;
...
use Src\Domain\Locations\Http\Resources\Location\LocationResourceCollection;
use Src\Domain\Locations\Http\Resources\Location\LocationResource;
...
class LocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $this->setData('title', __('main.show-all') . ' ' . __('main.location'));
    ...
    {
        $store = $this->locationRepository->create($request->validated());
    ...
    {
        $location=$this->locationRepository->spatie()->find($location);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(LocationUpdateFormRequest $request, $location)
    {
        $update = $this->locationRepository->update($request->validated(), $location);
    ...
    public function destroy($id)
    {
        ...
        $delete = $this->locationRepository->destroy($ids);
